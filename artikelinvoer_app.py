"""
Artikelinvoer — Lion Beddenshop (Streamlit web-app)
Beheer artikelen in Supabase via de browser.
"""
...
st.set_page_config(
    page_title="Artikelinvoer — Lion Beddenshop",
    page_icon="🛏",
    layout="wide",
)
...
st.title("🛏  Artikelinvoer — Lion Beddenshop")
...
with tab1:
    ...
    # Auto-selecteer bestaand pad als sectie al een pad heeft
    default_pad_idx = 0
